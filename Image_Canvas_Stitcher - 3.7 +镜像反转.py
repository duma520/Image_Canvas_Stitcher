...
from PySide6.QtGui import (
    ...
    QPen, QColor, QBrush, QIcon, QPixmap, QTransform
)
...
class SettingsDialog(QDialog):
    ...
    def _build_general_tab(self):
        ...
        layout.addRow("画布背景颜色:", bg_layout)
    ...
    def _build_performance_tab(self):
        ...
        self.perf_combo.addItem("平衡（推荐）", "balanced")
...
class ImageCanvasView(QGraphicsView):
    ...
    def __init__(self, scene, parent=None):
        ...
        self.setBackgroundBrush(QBrush(self._settings.get_background_color()))
...
class HistoryManager:
    ...
    def _render_thumbnail(self, items, bounds, output_path, max_size=400):
        ...
        settings = SettingsManager()
        img.fill(settings.get_background_color())
...
class MainWindow(QMainWindow):
    ...
    def _build_toolbar(self):
        ...
        self.lbl_global_opacity.setFixedWidth(35)
